...
import edu.todobot.bot.service.actions.additionalactions.CancelAction;
...
public class CancelActionFactory implements ActionsFactory {
    private final UsersService usersService;
    @Override
    public Actions run() {
        return new CancelAction(usersService);
    }

    @Override
    public List<String> getCommand() {
        return BotConfig.getCommand(CommandsData.CANCEL.getCommand());
    }
}
