...
import edu.todobot.bot.service.actions.editgoal.ChangeGoalDescription;
...
public class ChangeGoalDescriptionFactory implements RequestActionsFactory {
    private final GoalsService goalsService;
    private final UsersService usersService;
    @Override
    public RequestActions run() {
        return new ChangeGoalDescription(goalsService, usersService);
    }

    @Override
    public List<String> getCommand() {
        return BotConfig.getCommand(CommandsData.CHANGE_DESCRIPTION.getCommand());
    }
}
