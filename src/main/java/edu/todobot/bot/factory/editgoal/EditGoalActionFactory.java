...
import edu.todobot.bot.service.actions.editgoal.EditGoalAction;
...
public class EditGoalActionFactory implements RequestActionsFactory {
    private final GoalsService goalsService;
    private final UsersService usersService;
    @Override
    public RequestActions run() {
        return new EditGoalAction(goalsService, usersService);
    }

    @Override
    public List<String> getCommand() {
        return BotConfig.getCommand(CommandsData.EDIT_GOALS.getCommand());
    }
}
