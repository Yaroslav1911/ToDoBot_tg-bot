...
import edu.todobot.bot.service.actions.editgoal.ChangeGoalDeadline;
...
public class ChangeGoalDeadlineFactory implements RequestActionsFactory {
    private final GoalsService goalsService;
    private final UsersService usersService;
    @Override
    public RequestActions run() {
        return new ChangeGoalDeadline(goalsService, usersService);
    }

    @Override
    public List<String> getCommand() {
        return BotConfig.getCommand(CommandsData.CHANGE_DEADLINE.getCommand());
    }
}
