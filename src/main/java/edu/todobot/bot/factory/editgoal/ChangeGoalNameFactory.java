...
import edu.todobot.bot.service.actions.editgoal.ChangeGoalName;
...
public class ChangeGoalNameFactory implements RequestActionsFactory {
    private final GoalsService goalsService;
    private final UsersService usersService;
    @Override
    public RequestActions run() {
        return new ChangeGoalName(goalsService, usersService);
    }

    @Override
    public List<String> getCommand() {
        return BotConfig.getCommand(CommandsData.CHANGE_NAME.getCommand());
    }
}
